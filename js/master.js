...
const advisorLeftChevron = document.querySelector(".advisor-carousel .left-chevron");
const advisorRightChevron = document.querySelector(".advisor-carousel .right-chevron");
const advisorCarousel = document.querySelector(".advisors");

advisorLeftChevron?.addEventListener('click',() => {
  if(carouselWidth > 500){
      advisorCarousel.scrollLeft -= carouselWidth - 100;
  }
  else{
      advisorCarousel.scrollLeft -= carouselWidth-15;
  }
  
})

advisorRightChevron?.addEventListener('click',() => {
  if(carouselWidth > 500){
      advisorCarousel.scrollLeft += carouselWidth - 100;
  }
  else{
